			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title"><b>Kriptografi Hill Cipher</b></h4>
								...
								<label><b>Cara menggunanakan enkripsi hill cipher : </b></label>
								<ul>
									<li>Isilah plain text yang di inginkan</li>
									<li>Kemudian, tekan tombol <b>encrypt</b></li>
									<li>Maka cipher text akan keluar di sebelahnya</li>
									<br>
									-----------------------
					...
					<div class="col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<a href="Hill" class="btn btn-secondary" style="color:white;">Kembali ke Hill
											cipher</a> &nbsp;&nbsp;&nbsp;
										<a class="btn btn-info" style="color:white;" href="Hill_decrypt">Decrypt</a>
									</div>
								</div>
								<br>
								<div class="row">
										...
										<div id="inSec">
											<div id="encForm">
												...
												<textarea class="form-control pl-0 form-control-line"
													...
													rows="5" id="textP" name="plainM"></textarea>
											</div>
											<button id="encButton" class="btn btn-lg btn-success"
												style="color:white; margin-top:20px;" type="button">Encrypt</button>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-md-6">
						<div class="card" style="padding-bottom:20px;">
							<div class="card-body">
								...
								<textarea class="form-control pl-0 form-control-line" id="encT"
...
<script src="<?= base_url(); ?>assets/scripts_hill/encrypt.js"></script>
